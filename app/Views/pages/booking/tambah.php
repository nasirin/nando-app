                ...
                <form action="/booking/tambah" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="radio">
                                <label>
                                    <input type="radio" checked="" value="h_mingguan" id="optionsRadios1" name="optionsRadios">
                                    Mingguan
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" value="h_bulanan" id="optionsRadios2" name="optionsRadios">
                                    Bulanan
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" value="h_tahunan" id="optionsRadios2" name="optionsRadios">
                                    Tahunan
                                </label>
                            </div>
                        </div>
